...
> The notes are meant to subsidize or summarize the resources provided - not replace them. So if you do not understand something from the notes, please refer to the original resources for more context.
...
### 1. Android Profiling
[Notes](/Week8/PerformanceTools/2_AndroidProfiler.md)

### 2. Strict Mode
[Notes](/Week8/PerformanceTools/3_StrictMode.md)

### 3. LeakCanary
[Notes](/Week8/PerformanceTools/4_LeakCanary.md)

---

## Day-to-Day Performance Tools
### 4. Layout Inspector / Compose
[Notes](/Week8/PerformanceTools/5_LayoutInspector_Compose.md)

### 5. Network Inspector/Profiler
[Notes](/Week8/PerformanceTools/6_NetworkInspector.md)

### 6. Battery Historian / Power
[Notes](/Week8/PerformanceTools/7_BatteryHistorian.md)

---

## Benchmarking & Startup Optimizations
### 7. Jetpack Micro/Macro benchmark
[Notes](/Week8/PerformanceTools/8_MicroMacroBenchmark.md)

### 8. Baseline Profiles
[Notes](/Week8/PerformanceTools/9_BaselineProfiles.md)

---

## System-level & GPU Deep Dives
### 9. Systrace / Perfetto
[Notes](/Week8/PerformanceTools/10_Systrace_Perfetto.md)

### 10. GPU Profiling
[Notes](/Week8/PerformanceTools/11_GPU_Profiling.md)

---

## Production Monitoring & Observability 
### 11. Firebase Performance Monitoring
[Notes](/Week8/PerformanceTools/12_FirebasePerformanceMonitoring.md)

### 12. Crashlytics / ANR Reports
[Notes](/Week8/PerformanceTools/13_Crashlytics.md)

### 13. OpenTelemetry - Pre-built Telemetry SDK
[Notes](/Week8/PerformanceTools/14_OpenTelemetry.md)

### 14. CI Performance Checks
[Notes](/Week8/PerformanceTools/15_CI_Performance.md)

--- 

## Build / Size Optimization Tools
### 15. APK Analyzer
[Notes](/Week8/PerformanceTools/16_APK_Analyzer.md)

### 16. R8 Optimizer
[Notes](/Week8/PerformanceTools/17_R8_Optimizer.md)
